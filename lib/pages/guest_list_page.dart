            ...
            child: Container(
              ...
              child: Column(
                children: [
                  Row(
                    ...
                    children: [
                      Text(
                        ...
                        style: TextStyle(
                            fontSize:
                                Responsive.isSmallTablet(context) ? 44 : 48,
                        ...
                        children: [
                          RichText(
                            ...
                            text: TextSpan(
                                text: 'Employee: ',
                                style: TextStyle(
                                    fontSize: Responsive.isSmallTablet(context)
                                        ? 26
                                        : 30,
                  ...
                  Container(
                    height: Responsive.isSmallTablet(context) ? 450 : 700,
                            ...
                            child: RegularButton(
                              ...
                              onTap: () {
                                ...
                                if (selectedVisitor.isEmpty) {
                                  ...
                                  checkGuestStatus(selectedVisitor)
                                      .then((value) {
                                    // setState(() {
                                    //   model.setButtonLoading(false);
                                    // });
